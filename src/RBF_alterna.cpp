...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
//              Smoothing con SVD en la matriz CM (matriz E de coeficientes splines)
/////////////////////////////////////////////////////////////////////////////////////////////////////////////


/////////////////////////////////////////////////////////////////////////////////
// [[Rcpp::export]]
Rcpp::List RBF_LSPSVD(arma::vec y, arma::mat dsites, arma::mat ctrs, int RBFtype, const double R, const int neval,
                    const int omega){
  ...
  // CM de linea 14 de programa 19.2
  arma::mat IM_00 = radialFunction(DM_data, RBFtype, R);          // Matriz E del libro Green and Silverman
  
  
  // Aplicamos SVD a la matriz IM_0 (matriz E de Green and Silverman)
  arma::mat IM_0 = baseSVD(IM_00);
